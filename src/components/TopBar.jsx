...
export default function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-20 bg-white/70 backdrop-blur-xl border-b border-zinc-200/70">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3 flex items-center gap-3">
        {/* Brand / Tagline as a modern gradient bubble */}
        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="relative">
            ...
            <input
              className="w-64 rounded-lg bg-zinc-50 pl-9 pr-3 py-2 text-sm outline-none ring-1 ring-zinc-200 focus:ring-2 focus:ring-blue-400 transition"
              placeholder="Smarter Search"
            />
          </div>
          ...
          <button onClick={() => setOpen(!open)} className="h-9 px-2 rounded-lg bg-zinc-900 text-white text-sm inline-flex items-center gap-2">
            <div className="h-6 w-6 rounded-full bg-gradient-to-br from-purple-500 via-blue-500 to-cyan-400" />
            <span>Alex</span>
